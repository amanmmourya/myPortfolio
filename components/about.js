...
const about = () => {
    ...
    const skillSet = ["Java", "C++", "Python","R","HTML","CSS","Tailwind CSS", "JavaScript", "MongoDB","MySQL", "Node.js", "Express.js","SpringBoot","socket.io","Kafka","Redis","Mongoose ODM", "React", "Next.js","Docker","OpenCV","YOLO","Pyserial","Arduino IDE", "Numpy", "Matplotlib","Pandas", "LangChain", "LTSpice", "NGSpice", "MatLab","Verilog","Embedded C"]
    return (
        <section id='about'>
